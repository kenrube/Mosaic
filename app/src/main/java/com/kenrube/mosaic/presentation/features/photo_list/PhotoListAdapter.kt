...
class PhotoListAdapter(private val onClick: (UiPhoto) -> Unit) :
    ListAdapter<UiPhoto, PhotoListAdapter.ViewHolder>(diffCallback) {
    ...
    inner class ViewHolder(private val binding: RecyclerViewPhotoItemBinding) :
